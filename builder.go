...
// FindDiskPathOfImport maps an import path (e.g. "github.com/laqpay/laqpay/src/coin") to a path on disk,
...
func BuildStructEncoder(s *StructInfo, destPackage, fmtFilename string, exported bool) ([]byte, error) {
	...
	pkgHeader := fmt.Sprintf("// Code generated by github.com/laqpay/laqencoder. DO NOT EDIT.\n\npackage %s\n\n", pkgName)
...
func mapTypeName(t *types.Map, p *types.Package) string {
	...
	// map[int32]coin.UxOut will return "map[int32]github.com/laqpay/laqpay/src/coin.UxOut"
