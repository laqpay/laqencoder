...
func testLaqencoderMaxLenNestedMapKeyStruct2(t *testing.T, obj *MaxLenNestedMapKeyStruct2) {
...
func TestLaqencoderMaxLenNestedMapKeyStruct2(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenNestedMapKeyStruct2(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenNestedMapKeyStruct2DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenNestedMapKeyStruct2) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenNestedMapKeyStruct2DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenNestedMapKeyStruct2DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenNestedMapKeyStruct2DecodeErrors(t, i, "full", fullObj)
	}
}
