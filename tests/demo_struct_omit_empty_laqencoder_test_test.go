...
func testLaqencoderDemoStructOmitEmpty(t *testing.T, obj *DemoStructOmitEmpty) {
...
func TestLaqencoderDemoStructOmitEmpty(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderDemoStructOmitEmpty(t, tc.obj)
		})
	}
}
...
func testLaqencoderDemoStructOmitEmptyDecodeErrors(t *testing.T, k int, tag string, obj *DemoStructOmitEmpty) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderDemoStructOmitEmptyDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderDemoStructOmitEmptyDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderDemoStructOmitEmptyDecodeErrors(t, i, "full", fullObj)
	}
}
