...
func testLaqencoderMaxLenNestedMapKeyStruct1(t *testing.T, obj *MaxLenNestedMapKeyStruct1) {
...
func TestLaqencoderMaxLenNestedMapKeyStruct1(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenNestedMapKeyStruct1(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenNestedMapKeyStruct1DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenNestedMapKeyStruct1) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenNestedMapKeyStruct1DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenNestedMapKeyStruct1DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenNestedMapKeyStruct1DecodeErrors(t, i, "full", fullObj)
	}
}
