...
func testLaqencoderMaxLenAllStruct2(t *testing.T, obj *MaxLenAllStruct2) {
...
func TestLaqencoderMaxLenAllStruct2(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenAllStruct2(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenAllStruct2DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenAllStruct2) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenAllStruct2DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenAllStruct2DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenAllStruct2DecodeErrors(t, i, "full", fullObj)
	}
}
