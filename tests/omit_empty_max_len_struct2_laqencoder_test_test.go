...
func testLaqencoderOmitEmptyMaxLenStruct2(t *testing.T, obj *OmitEmptyMaxLenStruct2) {
...
func TestLaqencoderOmitEmptyMaxLenStruct2(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderOmitEmptyMaxLenStruct2(t, tc.obj)
		})
	}
}
...
func testLaqencoderOmitEmptyMaxLenStruct2DecodeErrors(t *testing.T, k int, tag string, obj *OmitEmptyMaxLenStruct2) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderOmitEmptyMaxLenStruct2DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderOmitEmptyMaxLenStruct2DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderOmitEmptyMaxLenStruct2DecodeErrors(t, i, "full", fullObj)
	}
}
