...
func testLaqencoderMaxLenNestedMapValueStruct2(t *testing.T, obj *MaxLenNestedMapValueStruct2) {
...
func TestLaqencoderMaxLenNestedMapValueStruct2(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenNestedMapValueStruct2(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenNestedMapValueStruct2DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenNestedMapValueStruct2) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenNestedMapValueStruct2DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenNestedMapValueStruct2DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenNestedMapValueStruct2DecodeErrors(t, i, "full", fullObj)
	}
}
