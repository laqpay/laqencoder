...
func testLaqencoderMaxLenNestedSliceStruct1(t *testing.T, obj *MaxLenNestedSliceStruct1) {
...
func TestLaqencoderMaxLenNestedSliceStruct1(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenNestedSliceStruct1(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenNestedSliceStruct1DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenNestedSliceStruct1) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenNestedSliceStruct1DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenNestedSliceStruct1DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenNestedSliceStruct1DecodeErrors(t, i, "full", fullObj)
	}
}
