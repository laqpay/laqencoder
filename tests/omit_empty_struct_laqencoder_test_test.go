...
func testLaqencoderOmitEmptyStruct(t *testing.T, obj *OmitEmptyStruct) {
...
func TestLaqencoderOmitEmptyStruct(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderOmitEmptyStruct(t, tc.obj)
		})
	}
}
...
func testLaqencoderOmitEmptyStructDecodeErrors(t *testing.T, k int, tag string, obj *OmitEmptyStruct) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderOmitEmptyStructDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderOmitEmptyStructDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderOmitEmptyStructDecodeErrors(t, i, "full", fullObj)
	}
}
