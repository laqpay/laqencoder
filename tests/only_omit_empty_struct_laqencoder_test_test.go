...
func testLaqencoderOnlyOmitEmptyStruct(t *testing.T, obj *OnlyOmitEmptyStruct) {
...
func TestLaqencoderOnlyOmitEmptyStruct(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderOnlyOmitEmptyStruct(t, tc.obj)
		})
	}
}
...
func testLaqencoderOnlyOmitEmptyStructDecodeErrors(t *testing.T, k int, tag string, obj *OnlyOmitEmptyStruct) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderOnlyOmitEmptyStructDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderOnlyOmitEmptyStructDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderOnlyOmitEmptyStructDecodeErrors(t, i, "full", fullObj)
	}
}
