...
func testLaqencoderMaxLenStringStruct2(t *testing.T, obj *MaxLenStringStruct2) {
...
func TestLaqencoderMaxLenStringStruct2(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenStringStruct2(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenStringStruct2DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenStringStruct2) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenStringStruct2DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenStringStruct2DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenStringStruct2DecodeErrors(t, i, "full", fullObj)
	}
}
