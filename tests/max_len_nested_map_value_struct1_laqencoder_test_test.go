...
func testLaqencoderMaxLenNestedMapValueStruct1(t *testing.T, obj *MaxLenNestedMapValueStruct1) {
...
func TestLaqencoderMaxLenNestedMapValueStruct1(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenNestedMapValueStruct1(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenNestedMapValueStruct1DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenNestedMapValueStruct1) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenNestedMapValueStruct1DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenNestedMapValueStruct1DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenNestedMapValueStruct1DecodeErrors(t, i, "full", fullObj)
	}
}
