...
func testLaqencoderDemoStruct(t *testing.T, obj *DemoStruct) {
...
func TestLaqencoderDemoStruct(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderDemoStruct(t, tc.obj)
		})
	}
}
...
func testLaqencoderDemoStructDecodeErrors(t *testing.T, k int, tag string, obj *DemoStruct) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderDemoStructDecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderDemoStructDecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderDemoStructDecodeErrors(t, i, "full", fullObj)
	}
}
