...
func testLaqencoderOmitEmptyMaxLenStruct1(t *testing.T, obj *OmitEmptyMaxLenStruct1) {
...
func TestLaqencoderOmitEmptyMaxLenStruct1(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderOmitEmptyMaxLenStruct1(t, tc.obj)
		})
	}
}
...
func testLaqencoderOmitEmptyMaxLenStruct1DecodeErrors(t *testing.T, k int, tag string, obj *OmitEmptyMaxLenStruct1) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderOmitEmptyMaxLenStruct1DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderOmitEmptyMaxLenStruct1DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderOmitEmptyMaxLenStruct1DecodeErrors(t, i, "full", fullObj)
	}
}
