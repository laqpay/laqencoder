...
func testLaqencoderMaxLenStringStruct1(t *testing.T, obj *MaxLenStringStruct1) {
...
func TestLaqencoderMaxLenStringStruct1(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			testLaqencoderMaxLenStringStruct1(t, tc.obj)
		})
	}
}
...
func testLaqencoderMaxLenStringStruct1DecodeErrors(t *testing.T, k int, tag string, obj *MaxLenStringStruct1) {
	isEncodableField := func(f reflect.StructField) bool {
		// Skip unexported fields
		if f.PkgPath != "" {
			return false
...
func TestLaqencoderMaxLenStringStruct1DecodeErrors(t *testing.T) {
	rand := mathrand.New(mathrand.NewSource(time.Now().Unix()))
	n := 10
	...
	for i := 0; i < n; i++ {
		...
		testLaqencoderMaxLenStringStruct1DecodeErrors(t, i, "empty", emptyObj)
		testLaqencoderMaxLenStringStruct1DecodeErrors(t, i, "full", fullObj)
	}
}
